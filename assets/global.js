...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
    ...
    if (!this.currentVariant) {
      ...
      this.updateShareUrl();
      this.updateVariantOffer(this.currentVariant);
    }
  }
 
  updateVariantOffer(currentVariant){
  const variantsOffers = document.querySelectorAll('.variant__offers');
    variantsOffers.forEach( function(variant) {
